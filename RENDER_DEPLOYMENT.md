...
3. **Set Environment Variables:**
   ```
   NODE_ENV=production
   VITE_API_BASE_URL=https://schooltransit-backend-staging-ixld.onrender.com/api/v1
...
| `VITE_API_BASE_URL` | `https://schooltransit-backend-staging-ixld.onrender.com/api/v1` | Backend API URL |
